...
if __name__ == '__main__':
    ...
    # Model parameters
    parser.add_argument('--input_dim', type=int, default=64, metavar='IN', help='Input dimension (default: 64)')
    parser.add_argument('--hidden_dim', type=int, default=10, metavar='HID', help='Hidden dimension (default: 10)')
    parser.add_argument('--output_dim', type=int, default=2, metavar='OUT', help='Output dimension (default: 2)')
